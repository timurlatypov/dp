            ...
            <table class="table table-shopping">
                ...
                <tr>
                    ...
                    <td colspan="6" style="vertical-align: top">
                        ...
                        <p class="text-muted">Бесплатная доставка по Москве при сумме заказа от 3000 руб. Доставка за МКАД по Московской области рассчитывается индивидуально. <span style="color: red;">Доставка осуществляется временно только по Москве и Московской области! Приносим извинения за временные неудобства.</span></p>
                    </td>
                </tr>
