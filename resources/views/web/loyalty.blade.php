                ...
                <div class="col-12 col-sm-8 col-md-9 px-3 px-sm-3 text-justify">
                    <div class="px-5 pb-5">
                        ...
                        <ul class="list-group">Схема расчета накопительной скидки.
                            <li class="list-group-item ml-3"><span class="text-danger pr-1 m-0 font-weight-bold">10% - ЕДИНОРАЗОВО</span> на первый заказ при регистрации на сайте</li>
                            <li class="list-group-item ml-3">3% - от 0 руб</li>
