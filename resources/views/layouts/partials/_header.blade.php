    ...
    <div class="hidden-lg bg-info">
        <div class="container px-5">
            <div class="row d-flex justify-content-between align-items-center font-bold py-2">
                ...
                <p class="tw-px-2 tw-font-bold tw-text-sm tw-text-white"><i class="fa fa-shipping-fast"></i>&nbsp;&nbsp;<a href="/delivery" class="tw-text-white">БЕСПЛАТНАЯ ДОСТАВКА ОТ 6000р.</a></p>
