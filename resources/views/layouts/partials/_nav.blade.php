    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mx-auto">
                ...
                @guest
                    <a class="btn btn-primary btn-sm show-lg m-3" href="{{ route('login') }}"><i class="material-icons">account_box</i>
                        Войти
                        <div class="ripple-container"></div>
                    </a>
                @else
                    <a class="btn btn-primary btn-sm show-lg m-3" href="{{ route('account.profile') }}"><i
                                class="material-icons">account_box</i> Кабинет
                        <div class="ripple-container"></div>
                    </a>
                @endguest
...
{{--                                <h4 class="title my-0 px-3 px-md-4 mt-md-4 mb-md-2">--}}
{{--                                    <nobr>Для лица</nobr>--}}
{{--                                </h4>--}}
{{--                                @foreach($for_face->subcategories as $subcategory)--}}
...
{{--                                    <a class="dropdown-item{{ request()->is('category/for-body/'.$subcategory->slug) ? ' active' : '' }}"--}}
{{--                                       href="{{ route('show.category.subcategory', [$for_body, $subcategory]) }}">{{ $subcategory->name }}</a>--}}
{{--                                @endforeach--}}
{{--                            </div>--}}
{{--                            <div style="min-width: 200px;">--}}
{{--                                <h4 class="title my-0 px-3 px-md-4 mt-md-4 mb-md-2">--}}
{{--                                    <nobr>Направленный уход</nobr>--}}
{{--                                </h4>--}}
{{--                                @foreach($direct_care->subcategories as $subcategory)--}}
{{--                                    <a class="dropdown-item{{ request()->is('category/direct-care/'.$subcategory->slug) ? ' active' : '' }}"--}}
                    ...
                    <div class="dropdown-menu dropdown-with-icons">
                        @foreach($brands as $brand)
                            <a class="dropdown-item small"
                               href="{{ route('show.brand.products', $brand) }}">{{ $brand->name }}</a>
                        @endforeach
                    </div>
                </li>
...
{{--                <li class="nav-item"><a class="nav-link" href="/contacts">Контакты</a></li>--}}
                ...
                @guest
                @else
                    <button type="button" class="btn btn-default btn-sm show-lg m-3"
